...
<Grid >
            ...
            <Flex   alignItems='center' gap={'10px'} >
                <Image width={"30px"}height={20} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/Credit_Debit_Card.svg' alt='left'></Image>
                <Box>
            ...
            <Box paddingTop={"10px"} onClick={()=>setPayment(3)} cursor='pointer' h={'70px'} style={payment==3?white:gray}  >
            <Flex gap={'10px'} alignItems='center'>
                <Image width={"30px"}height={"30px"} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/UPI.svg' alt='left'></Image>
                <Box>
            ...
            <Box paddingTop={"10px"} h={'70px'}  bgColor={'#f3f4f5'} >
            <Flex gap={'10px'} alignItems='center'>
                <Image width={"20px"}height={10} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/Netbanking.svg' alt='left'></Image>
                <Box>
            ...
            <Flex gap={'10px'} alignItems='center'>
                <Image width={"30px"} height={20} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/Snpl.svg' alt='left'></Image>
                <Box>
            ...
            <Flex gap={'10px'} alignItems='center'>
                <Image width={"30px"}height={20} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/COD.svg' alt='left'></Image>
                <Box  >
            ...
            <Box h={'70px'}  bgColor={'#f3f4f5'} >
            <Flex gap={'10px'} alignItems='center'>
                <Image width={"30px"}height={20} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/PaytmPaymentOption.svg' alt='left'></Image>
                <Box>
            ...
            <Box h={'70px'}  bgColor={'#f3f4f5'} >
            <Flex gap={'10px'} alignItems='center'>
                <Image width={"30px"}height={20} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/GiftCard.svg' alt='left'></Image>
                <Box>
            ...
            <Box h={'70px'}  bgColor={'#f3f4f5'} >
            <Flex gap={'10px'} alignItems='center'>
                <Image width={"30px"}height={20} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/EMI.svg' alt='left'></Image>
                <Box>
            ...
            <Box w='40%' >
              {
               ...
               <Box paddingTop={'10px'}>
                ...
                <Image width={"30px"}height={"20px"} src={'https://adn-static1.nykaa.com/media/wysiwyg/Payments/WeAccept/VISA.svg'}alt='visa' />
                <Image width={"30px"}height={"20px"} src={'https://adn-static1.nykaa.com/media/wysiwyg/Payments/WeAccept/mastercard.svg'}alt='visa' />
                <Image width={"30px"}height={"20px"} src={'https://adn-static1.nykaa.com/media/wysiwyg/Payments/WeAccept/Rupay.svg'}alt='visa' />
                <Image width={"30px"}height={"20px"} src={'https://adn-static1.nykaa.com/media/wysiwyg/Payments/WeAccept/AMEX.svg'}alt='visa' />
                </Flex>
               </Box>
...
}
{
  ...
  <Heading paddingTop={'10px'} boxShadow='md' p='6' rounded='md' bg='white' size={'md'}>UPI</Heading>
    ...
    <Box>
      ...
      <Image width={"30px"}height={"30px"} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/fashion_icons/googlePay.svg'alt='goopay'/>
      <Image width={"30px"}height={"30px"} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/UPImWeb/PhonePe.svg'alt='phone'/>
      <Image width={"30px"}height={"30px"} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/UPImWeb/Paytm.svg'alt='paytm'/>
      <Image width={"30px"}height={"30px"} src='https://adn-static1.nykaa.com/media/wysiwyg/Payments/UPImWeb/UPI-Logo-vector%201.svg'alt='upi'/>
      </Flex>
    </Box>
